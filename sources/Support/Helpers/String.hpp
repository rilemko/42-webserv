...
/*   Updated: 2024/07/26 19:27:42 by mconreau         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class String
{
	...
	public   :
		...
		static string				rand(const size_t &size, const string &set = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789");
